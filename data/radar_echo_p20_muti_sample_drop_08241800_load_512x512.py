...
class generator():
    def __init__(self, radar_echo_dataframe,
        ...
        # print("np.array(radar_echo_dataframe['Sun_Moon_Lake'].values[0].tolist()).shape=",np.array(radar_echo_dataframe['Sun_Moon_Lake'].values[0].tolist()).shape)
        self._data_shape = np.array(radar_echo_dataframe['Sun_Moon_Lake'].values[0].tolist()).shape
