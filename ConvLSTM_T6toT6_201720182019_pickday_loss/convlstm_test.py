...
if __name__ == "__main__":                
    ...
    # load_radar_echo_df_path='ConvLSTM_T6toT6_201720182019_pickday_loss/2017to2018_pick_day.pkl'#'online_test/T12toT6_test_512x512_.pkl'
    
    save_path ='ConvLSTM_T6toT6_201720182019_pickday_loss/'
    ...
    #    scaler = StandardScaler()
        ...
        model_name = 'model_loss_itr6_test_cost27.730223743236014.pkl'
       
        test_show(model, save_path, model_name,itr=27)
